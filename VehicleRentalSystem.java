...
class VehicleRentalSystem {
    ...
    public static void main(String[] args) {
        ...
        Car car1 = new Car("AR-34", "camaro", 50.0, true);
        Motorcycle motorcycle1 = new Motorcycle("TA-34", "BMW", 30.0, false);
        Truck truck1 = new Truck("AE-55", "Tacoma", 70.0, 1000);
        ...
        // Create a customer
        Customer customer = new Customer("1234567", "Alex");

        // Rent a vehicle
        agency.rentVehicle("AR-34", customer, 3);
        agency.rentVehicle("AE-55", customer,6 );

        // Return vehicles
        agency.returnVehicle("AR-34");
        agency.returnVehicle("AE-55");
